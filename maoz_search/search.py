...
# beyond the machine that started it (see README, "Sharing the demo"), where every
# visitor writes into the same overlay: the cap bounds both memory and how far one
# visitor can push the corpus the next visitor searches.  `reset()` clears it.
